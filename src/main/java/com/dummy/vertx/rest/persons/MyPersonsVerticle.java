...
import static com.dummy.vertx.rest.persons.Constants.PERSONS_TABLE;
...
public class MyPersonsVerticle extends AbstractVerticle {
    ...
    public void start(Future<Void> fut) {
        MongoClient mongoClient = MyMongoFactory.createDefault(vertx);
        ...
        router
                ...
                .handler(routingContext -> {
                    mongoClient.find(PERSONS_TABLE, new JsonObject(), result -> {
        ...
        router
                ...
                .handler(routingContext -> {
                    ...
                    mongoClient.findOne(PERSONS_TABLE, searchObj, null, result -> {
                        HttpServerResponse response = routingContext.response();
                        response.putHeader(CONTENT_TYPE_HEADER, APPLICATION_JSON_TYPE);
        ...
        router
                ...
                .handler(routingContext -> {
                    ...
                    mongoClient.save(PERSONS_TABLE, personJson, res -> {
                        if (res.succeeded()) {
                            ...
                            if (id == null) {
                                ...
                                mongoClient.findOne(PERSONS_TABLE, new JsonObject().put(MONGO_ID_PROP, id), null, findRes -> {
                                    HttpServerResponse response = routingContext.response();
                                    response.putHeader(CONTENT_TYPE_HEADER, APPLICATION_JSON_TYPE);
